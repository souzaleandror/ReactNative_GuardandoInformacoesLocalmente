...
export default function NotaEditor({ mostraNotas, notaSelecionada, setNotaSelecionada }) {
  ...
  function preencheModal(notaSelecionada) {
  ...
  async function deleteNota() {
    await removeNota(notaSelecionada.id);
    limpaModal();
    mostraNotas();
  }
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={estilos.modal}>
              ...
              <TextInput
                ...
                placeholder="Digite um titutlo"
                value={titulo} />
              <Text style={estilos.modalSubTitulo}>Categoria</Text>
              <View style={estilos.modalPicker}>
                <Picker selectValue={categoria} onValueChange={novoCategoria => setCategoria(novoCategoria)}>
              ...
              <View style={estilos.modalBotoes}>
                ...
                {notaParaAtualizar ? <TouchableOpacity style={estilos.modalBotaoDeletar} onPress={() => limpaModal()}>
